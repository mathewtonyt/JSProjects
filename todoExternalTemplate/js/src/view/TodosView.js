	   ...
	   $,
		...
		Mustache
		   ...
		   var TodosView = Backbone.View.extend({
			   ...
			   template : function(inputTemplate,model) {
				   var returnVal = Mustache.render(inputTemplate,model);
				   return returnVal;
			   },
			   ...
			   render: function() {
				   ...
				   var fetchTemplate = require(['text!js/src/templates/itemTemplate.htm']);
				   var element = this.template(fetchTemplate,data);
